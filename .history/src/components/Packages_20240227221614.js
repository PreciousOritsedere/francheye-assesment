...
export default function Packages() {
  ...
  const filteredPackages = packages.filter((pkg) => {
    const typeMatch = pkg.packageType === activeTab; // Ensure package type matches active tab (e.g., UGC, Affiliates)
    const categoryMatch = pkg.category === activeSubTab; // Ensure package category matches active sub-tab (e.g., Videos, Photos)
