  ...
  return (
    <main className="max-w-[774px] w-full flex flex-col gap-24 mt-48 p-10 relative">
      ...
      <section className="flex flex-col gap-[51px]">
        <section className="flex  flex-col gap-10 items-center md:items-start md:flex-row md:justify-between">
          <div className="max-w-[452px] w-full flex flex-col gap-9 p-2.5">
          ...
          <div className="flex flex-col gap-10 items md:items-end">
