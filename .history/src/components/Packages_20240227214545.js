        ...
        <section className="w-full flex flex-col gap-[30px]">
          <div className="w-full flex items-center rounded-[10px]">
            <div
              ...
              className={`w-full bg-white p-[22px] text-center text-[#111111] cursor-pointer rounded-l-[10px] ${activeTab === "UGC" ? "bg-[#0014BC] !important text-white" : ""}`}
            ...
            <div
              ...
              className={`w-full bg-white p-[22px] text-center text-[#111111] cursor-pointer rounded-r-[10px] ${
                activeTab === "Affiliates" ? "bg-[#0014BC] text-white" : ""
              }`}
            >
              Affiliates
            </div>
