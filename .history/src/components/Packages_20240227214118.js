      ...
      <section className="w-full flex flex-col gap-[50px]">
        <section className="w-full flex flex-col gap-[30px]">
          <div className="w-full flex items-center rounded-[10px]">
            <div onClick={() => handleTabClick('UGC')} className="w-full bg-white p-[22px] text-center text-[#111111] cursor-pointer rounded-l-[10px]">
              UGC
            </div>
            <div className="w-full bg-white p-[22px] text-center text-[#111111] cursor-pointer rounded-r-[10px]">
            Affiliates
            </div>
          </div>
        </section>
